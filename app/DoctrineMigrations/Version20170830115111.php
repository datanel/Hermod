...
class Version20170830115111 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE equipment (id INT NOT NULL, code VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, station_id VARCHAR(255) NOT NULL, station_name VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, direction VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'2017-08-30 11:50:02.64117\' NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'2017-08-30 11:50:02.64117\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE equipment_status (id INT NOT NULL, user_id INT DEFAULT NULL, equipment_id INT DEFAULT NULL, source_name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, reported_status VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'2017-08-30 11:50:02.64117\' NOT NULL, include_user_geolocation BOOLEAN NOT NULL, user_geolocation_lat DOUBLE PRECISION NOT NULL, user_geolocation_lon DOUBLE PRECISION NOT NULL, user_gps_accuracy DOUBLE PRECISION NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'2017-08-30 11:50:02.64117\' NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE api_user ALTER created_at SET DEFAULT \'2017-08-30 11:50:02.64117\'');
        $this->addSql('ALTER TABLE api_user ALTER updated_at SET DEFAULT \'2017-08-30 11:50:02.64117\'');
    }
}
