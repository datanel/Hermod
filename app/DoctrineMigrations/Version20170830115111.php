...
class Version20170830115111 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE stop_point (id INT NOT NULL, name VARCHAR(255) NOT NULL, route_id VARCHAR(255) NOT NULL, route_name VARCHAR(255) NOT NULL, code VARCHAR(255) NOT NULL, source_name VARCHAR(255) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id))');
