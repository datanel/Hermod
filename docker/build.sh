...
docker build --build-arg VERSION=${VERSION} --rm -t hermod_php:${VERSION} -f docker/php/Dockerfile .
docker build --rm -t hermod_nginx:${VERSION} -f docker/nginx/Dockerfile .
